...
C'è da dire che nel mezzo è passata tanta merda e tanti problemi gli ho dovuti correggere a mano, ma sono piacevolmente colpito. Un altro codice che ho dato in pasto a 'opencode' è uno shared object injection scritto decenni fa quando c'era ancora **"__libc_dlopen_mode"** e **dlopen** non era ancora in libc. Vabbé, integrato facile in un progetto del genere.
